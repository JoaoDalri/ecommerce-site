    ...
    <div className="min-h-screen pt-28 pb-20 container mx-auto px-4">
      ...
      {items.length === 0 ? (
        <motion.div 
            ...
            className="glass-panel p-12 rounded-3xl text-center max-w-2xl mx-auto"
        >
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            <AnimatePresence>
              {items.map(i => (
                <motion.div 
                  ...
                  className="glass-card p-4 rounded-2xl flex items-center gap-6"
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-400 mb-2">ID: {i.id.substring(0,6)}</p>
            ...
            <div className="flex justify-end pt-4">
                <button onClick={() => clear()} className="text-sm text-red-400 hover:text-red-300 font-medium">
                    Esvaziar Carrinho
                </button>
            </div>
          </div>

          <div className="glass-panel p-6 rounded-3xl h-fit sticky top-28">
